...
Product.create(name:'Bison',price: 100.00, quantity:10, category: 'STREET_FIGHTER_2', image: 'https://www.sfgalleries.net/art/sf2/st-gba/portraits/vega.jpg')
Product.create(name:'Ken',price: 28.00, quantity:3, category:'STREET_FIGHTER_2', image:'https://res.cloudinary.com/ducg1tnoi/image/upload/v1706800373/gouki_jktbt9.jpg')